package rosegold.gumtuneaddons.modules.macro;
...
import rosegold.gumtuneaddons.utils.GuiUtils;
...
public class AutoHarp {
    ...
    public final void onTick(@Nullable TickEvent.ClientTickEvent event) {
        ...
        if (this.wait != 0) {
            ...
            if (this.wait != GumTuneAddonsConfig.harpMacroDelay + 1 /* wait = 1 */) {
                return;
            }
        ...
        if (!inHarp || !GumTuneAddonsConfig.harpMacro || mc.thePlayer == null) return;
